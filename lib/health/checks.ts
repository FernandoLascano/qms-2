...
async function runCheck(
  ...
  try {
    ...
    return { key, label, status: 'down', latencyMs: Date.now() - started, detail: message.slice(0, 200) }
  }
}
...
/** Ejecuta todos los chequeos de servicios en paralelo. Sin efectos secundarios. */
