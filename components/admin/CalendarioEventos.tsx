            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="flex h-10 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent"
                    >
                ...
                <div className="flex gap-2 justify-end">
                  ...
                  <Button onClick={handleCrearEvento} className="bg-red-600 hover:bg-red-700">
                    Crear Evento
                  </Button>
                </div>
              </div>
