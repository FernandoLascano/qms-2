...
export default function ReportingPagos({ pagos }: ReportingPagosProps) {
  ...
  return (
    <div className="border-primary-line bg-primary-soft rounded-control">
      <CollapsibleCard
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-success-soft border border-success-line rounded-control p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-body-sm font-medium text-success">Cobrado</span>
              <CheckCircle className="h-5 w-5 text-success" />
            </div>
            <p className="text-title font-semibold text-success">
          ...
          <div className="bg-warning-soft border border-warning-line rounded-control p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-body-sm font-medium text-warning">Pendiente</span>
              <Clock className="h-5 w-5 text-warning" />
            </div>
            <p className="text-title font-semibold text-warning">
          ...
          {pagosRechazados.length > 0 && (
            <div className="bg-primary-soft border border-primary-line rounded-control p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-body-sm font-medium text-primary">Rechazado</span>
                <AlertCircle className="h-5 w-5 text-primary" />
              </div>
              <p className="text-title font-semibold text-primary">
                ${totalRechazado.toLocaleString('es-AR')}
              </p>
              <p className="text-label text-primary mt-1">
        ...
        <div className="bg-info-soft border-2 border-info-line rounded-control p-4">
          <div className="flex items-center justify-between">
            <span className="text-heading font-semibold text-info">Total General</span>
            <span className="text-title font-semibold text-info">
              ${totalAprobado.toLocaleString('es-AR')}
            </span>
          </div>
          {totalPendiente > 0 && (
            <p className="text-body-sm text-info mt-2">
