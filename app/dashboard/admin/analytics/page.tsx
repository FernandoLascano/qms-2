    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-red-900 mb-2">📊 Dashboard de Analytics</h1>
        ...
        {/* Filtros */}
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 bg-white p-4 rounded-lg shadow-md">
          ...
          <div className="flex items-end">
            <button
              onClick={fetchData}
              className="w-full sm:w-auto bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-lg text-gray-700 font-medium transition"
            >
              🔄 Actualizar
            </button>
          </div>
      ...
      {data.comparativas && (
        <>
          <div className="mb-4">
            <h2 className="text-xl sm:text-2xl font-bold text-red-900">📊 Comparativa vs Mes Anterior</h2>
            <p className="text-gray-600">Evolución de métricas clave</p>
          </div>
